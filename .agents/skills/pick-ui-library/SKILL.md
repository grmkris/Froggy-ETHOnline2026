...
description: Choose a frontend library from a curated list for controls, charts, virtualization, drag and drop, toasts, state and styling. Use only when explicitly invoked.
