...
description: Audit existing motion across a codebase and write prioritized, self-contained implementation plans. Read-only on source until the user requests execution.
---
