---
name: animate
description: Build purposeful web UI animation, choosing properties, timing, interruption and reduced-motion behavior. Use review-animations for a diff or improve-animations for a codebase audit.
---
