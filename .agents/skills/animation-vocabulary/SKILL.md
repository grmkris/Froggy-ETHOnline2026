...
description: Name a web motion effect from a plain-language description. Use for identifying animation terminology, not for designing or implementing an effect.
---
