...
description: Read-only audit of missing motion opportunities. Recommend only purposeful effects with exact values; use improve-animations to audit existing motion.
---
