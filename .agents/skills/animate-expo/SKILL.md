---
name: animate-expo
description: Build and fix React Native and Expo motion with Reanimated, gestures, screen transitions and haptics. Choose thread ownership, interruption and reduced-motion behavior.
---
