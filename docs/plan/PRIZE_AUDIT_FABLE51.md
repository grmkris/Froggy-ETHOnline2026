...
| AI-tool usage must be documented; spec-driven work must include all spec files, prompts and planning artifacts | AI-USE.md plus `docs/` and `../research/` committed; the `IDEAS*.md` and `*_FABLE51.md` files stay in the repo | Jonas |
