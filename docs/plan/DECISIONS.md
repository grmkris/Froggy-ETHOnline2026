...
| new | **Mainnet everywhere, tonight (Sun 6 Sep 21:40 CEST).** Production flips to Hedera mainnet and Base mainnet as soon as the owner's HBAR and USDC land and one Blocky402 mainnet settlement passes; the run flips on its own and posts in the group. Test spend capped at 25 HBAR from the float and $5 USDC from the treasury, every id recorded. | Kristjan |
