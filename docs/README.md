...
- `plan/` — the product spec, prize audit, user flows, day plans and the earlier brainstorm (`PLAN_v1.md`, `ARCHITECTURE_v1.md`, `summary.md`); `plan/README.md` is the reading order and `plan/STATUS.md` is what has landed.
