...
- **Telegram** is a pager with pairing codes; Telegram OAuth login only if a 30-minute test on Saturday resolves the same DID; Privy Intents only inside the Wednesday box.
