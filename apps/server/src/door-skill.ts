/** Historical anonymous-door install links explain the account migration. */
...
Sign in at ${input.url}, then read [the current Froggy skill](${input.url}/skill.md). Connect your MCP client with OAuth:
