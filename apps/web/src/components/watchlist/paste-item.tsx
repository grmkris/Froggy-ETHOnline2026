...
import { WalletMonitorPanel } from "./wallet-monitor-panel";
...
const PreviewForm = ({
  ...
  readonly previewRef: WatchlistPreview["ref"];
  ...
  if (candidate.source._tag === "wallet") {
    price = 0;
  }
  if (candidate.source._tag === "token") {
    price =
        ...
        <div className="grid gap-4 sm:grid-cols-[1fr_10rem]">
          ...
          <Field>
            ...
            <NativeSelect
              id="preview-kind"
              name="kind"
              defaultValue={candidate.source._tag}
            >
              {address ? (
                <>
