...
): readonly WebMcpTool[] => [
  {
    ...
    execute: async () => {
      ...
      return wallet === null
        ...
        : `Address ${wallet.address ?? "unknown"}; ${formatUsd(wallet.windowSpentUsdMicros)} spent in the current window; balance ${wallet.totalUsdMicros === null ? wallet.balanceLabel : formatUsd(wallet.totalUsdMicros)}.`;
    },
